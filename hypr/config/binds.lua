...
hl.bind(mainMod .. " + SHIFT + T",  hl.dsp.window.focus({ class = "teams-for-linux" }))
...
hl.bind(mainMod .. " + SHIFT + L",  hl.dsp.exec_cmd("hypr-persist save last && " .. noctCall .. "session logout"))
hl.bind(mainMod .. " + SHIFT + R",  hl.dsp.exec_cmd("hypr-persist save last && " .. noctCall .. "session reboot"))
hl.bind(mainMod .. " + SHIFT + S",  hl.dsp.exec_cmd("hypr-persist save last && " .. noctCall .. "session shutdown"))
...
hl.bind("XF86Launch1",          hl.dsp.exec_cmd(noctCall .. "panel-toggle launcher"))
hl.bind("XF86Launch2",          hl.dsp.exec_cmd(noctCall .. "panel-toggle control-center"))
